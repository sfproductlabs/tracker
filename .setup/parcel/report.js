/* From https://github.com/sfproductlabs/tracker
...
export default (userAgent) => {
    let report, match, uuid, definePropertySupported;
    ...
    document.cookie = uuid + "= test; SameSite=Lax";
    ...
    report.screen.width = window.screen.width;
    report.screen.height = window.screen.height;
    report.screen.colors = window.screen.colorDepth;
